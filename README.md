# Project Springboot REST Integration Swagger Documentation
...
Em construction - Sample API expose endpoints with autentication to using Openfegin to make the connections between APIS.

### Configurate Docker to use in this project
